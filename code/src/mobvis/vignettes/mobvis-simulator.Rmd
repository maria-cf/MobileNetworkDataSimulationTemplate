...
```{r chunk4}
sim <- list(simConfig_dir = "simdata/simConfig",
            resources_dir = "simdata/resources",
            networkEvents_dir = "simdata/networkEvents",
            postLocProb_dir = "simdata/postLocProb",
            mno = "MNO1",
            crs = sf::st_crs(NA))
```
...
```{r chunk5, fig.show="hold", out.width="80%"}
...
```{r chunk7, fig.show="hold", out.width="80%"}
...
```{r chunk8, fig.show="hold", out.width="80%"}
